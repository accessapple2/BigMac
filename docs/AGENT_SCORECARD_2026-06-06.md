# Agent Scorecard — 2026-06-07 03:39:37 UTC
Window: last 180d · 1099 closed trades · 26 agents · SR0(null)=2.4659
...
|--:|-------|-------|------:|----:|------:|----:|----:|----:|-----:|-------:|
| 1 | energy-arnold | ministral-3:3b | 13 | 100.0 | +2.38 | 0.385 | +1.9 | +0.150 | +168 | 0 |
| 2 | gemini-2.5-flash | ministral-3:3b | 22 | 95.5 | +2.15 | 0.278 | +2.1 | +0.097 | +165 | -3 |
| 3 | cto-grok42 | qwen3:8b | 16 | 93.8 | +1.93 | 0.111 | +1.1 | +0.071 | +56 | -0 |
| 4 | neo-matrix | 8000 / Independent | 33 | 93.9 | +1.86 | 0.093 | +1.9 | +0.058 | +130 | -1 |
| 5 | grok-4 | deepseek-r1:7b | 17 | 100.0 | +1.73 | 0.002 | +0.7 | +0.041 | +32 | 0 |
...
| 8 | dayblade-sulu | qwen3:8b | 10 | 60.0 | +0.67 | 0.000 | +0.1 | +0.013 | -451 | -3 |
| 9 | options-sosnoff | qwen3:8b | 4 | 100.0 | +0.66 | 0.000 | +0.2 | +0.039 | +2,060 | 0 |
...
| option | 7 | 294 | 12.9 | -30,438 |

**Population PBO (CSCV): 0.0284** (OK; n_splits=12870, agents=18)

## Notes
- **DSR gate (≥0.95):** 0 agents clear it — NONE. After multiple-testing deflation across 26 agents (SR0_null=2.4659), no track record is statistically robust yet — expected at ~150 days / modest n. Top raw-DSR: energy-arnold=0.3853, gemini-2.5-flash=0.2781, cto-grok42=0.111.
