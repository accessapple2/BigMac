...
RANK, ALPHA = 16, 16
OUT_LORA = "/home/bigmac/plutus-v7d-lora"
OUT_CKPT = "/home/bigmac/plutus-v7d-checkpoints"
EVAL_STEPS = 12

print(f"=== train_plutus_v7d | rank={RANK} alpha={ALPHA} lr2e-4 | early-stop | rank16, eval_steps={EVAL_STEPS} ===")
