...
RANK, ALPHA = 8, 8
OUT_LORA = "/home/bigmac/plutus-v7c-lora"
OUT_CKPT = "/home/bigmac/plutus-v7c-checkpoints"
EVAL_STEPS = 16

print(f"=== train_plutus_v7c | rank={RANK} alpha={ALPHA} lr5e-5 | early-stop give-it-room, eval_steps={EVAL_STEPS} ===")
...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        ...
        warmup_steps=10, num_train_epochs=5, learning_rate=5e-5,
