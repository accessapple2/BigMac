...
AI_PLAYERS = [
    ...
    {"id": "ollama-plutus",   "name": "Uhura Plutus",       "provider": "ollama", "model": "plutus-v1",    "url": OLLIE_URL},  # Ollie GPU — McCoy's finance brain; HM-OLLIE-30B-BAKEOFF-REVERT 2026-09-09 after-hours: outcome-scored 8B(n=135)/30B(n=177) BUYs fwd-to-close, Welch t=-1.32 (not significant), 8B win-rate 38.5% vs 30B 29.9% -- 30B not clearly better, rule says stay 8B -- was qwen3:30b-a3b-instruct-2507-q4_K_M
    ...
    {"id": "qwen3-8b-flash","name": "Worf 8B",            "provider": "ollama", "model": "qwen3:8b",          "url": OLLIE_URL},  # Ollie GPU — was gemini; HM-OLLIE-30B-BAKEOFF-REVERT 2026-09-09 after-hours, same call as McCoy -- was qwen3:30b-a3b-instruct-2507-q4_K_M
