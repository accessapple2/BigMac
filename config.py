...
AI_PLAYERS = [
    ...
    {"id": "ollama-plutus",   "name": "Uhura Plutus",       "provider": "ollama", "model": "qwen3:30b-a3b",    "url": OLLIE_URL},  # Ollie GPU — McCoy's finance brain; HM-OLLIE-30B-CUTOVER 2026-09-08, was plutus-v1
    ...
    {"id": "qwen3-8b-flash","name": "Worf 8B",            "provider": "ollama", "model": "qwen3:30b-a3b",          "url": OLLIE_URL},  # Ollie GPU — was gemini; HM-OLLIE-30B-CUTOVER 2026-09-08, was qwen3:8b
