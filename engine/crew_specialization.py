...
ADVISORY_CREW: list[str] = [
    ...
    "ollama-local",     # Geordi
    "qwen3-8b-4o",           # Janeway
    "qwen-coder-haiku",     # Reed
    "qwen3-8b-sonnet",    # Sisko
    "qwen3-8b-o3",           # Tuvok
    "qwen3-14b-grok3",           # Hoshi
    "ollama-kimi",      # Bashir
    "ollama-glm4",      # Q
    "ollama-deepseek",  # Odo
    ...
    "qwen3-8b-flash", # Worf  — benched S6.1 (-0.36%)
    "qwen3-14b-pro",   # Seven — benched S6.1 (+0.64% meh)
...
AGENT_STRATEGIES: dict[str, list[str]] = {
    ...
    # ── SCOUTS ───────────────────────────────────────────────────────────────
    "deepseek-7b-grok4":         ["rsi_bounce", "mean_reversion"],
...
CREW_MANIFEST: dict[str, dict[str, Any]] = {
    ...
    "ollama-local": {
        ...
        "model": "qwen3:30b-a3b-instruct-2507-q4_K_M",  # HM-OLLIE-30B-LIVE 2026-09-09, repointed with McCoy/Worf/Troi -- seat is halt_mode='full' (culled 2026-06-06/07-04), doesn't affect live traffic
        "max_positions": 2,
        "size_factor": 1.0,
        "bridge_voter": False,
        "conditions": {
...
def should_agent_trade(player_id: str, market_data: dict) -> tuple[bool, str]:
    ...
    Args:
        player_id  : DB player id (e.g. "deepseek-7b-grok4")
...
if __name__ == "__main__":
    ...
    print("\n=== GATE TESTS ===")
    tests = [
        ("deepseek-7b-grok4",     {"session_type": "TRENDING_BULL"},                "Spock → blocked (trending)"),
        ("deepseek-7b-grok4",     {"session_type": "CHOP", "rsi": 28},              "Spock → allowed (chop+oversold)"),
        ...
        ("qwen-coder-haiku", {},                                             "Lt. Malcolm Reed → bridge voter"),
    ]
