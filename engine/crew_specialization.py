...
CREW_MANIFEST: dict[str, dict[str, Any]] = {
    ...
    "ollama-local": {
        ...
        "model": "gemma3:4b",  # HM-OLLIE-30B-BAKEOFF-REVERT 2026-09-09, reverted with McCoy/Worf/Troi -- seat is halt_mode='full' (culled 2026-06-06/07-04), doesn't affect live traffic
        "max_positions": 2,
        "size_factor": 1.0,
        "bridge_voter": False,
        "conditions": {
