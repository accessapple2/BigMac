...
MODEL_MAP = {
    ...
    "gpt-4": "qwen3-8b-4o",
    "qwen3-8b-4o": "qwen3-8b-4o",
    "qwen3-8b-o3": "qwen3-8b-o3",
    "claude": "qwen3-8b-sonnet",
    "codex": "qwen3-8b-sonnet",
    "codex-prime": "qwen3-8b-sonnet",
    "codex-scout": "qwen-coder-haiku",
    "qwen3-8b-sonnet": "qwen3-8b-sonnet",
    "qwen-coder-haiku": "qwen-coder-haiku",
    "gemini": "qwen3-8b-flash",
    "gemini-flash": "qwen3-8b-flash",
    "gemini-pro": "qwen3-14b-pro",
    "grok": "deepseek-7b-grok4",
    "deepseek-7b-grok4": "deepseek-7b-grok4",
    "qwen3-14b-grok3": "qwen3-14b-grok3",
    "llama": "ollama-llama",
    "qwen": "ollama-qwen3",
    "gemma": "ollama-local",
    # Display name mapping
    "Spock": "deepseek-7b-grok4",
    "Worf": "qwen3-8b-flash",
...
CREW_NAMES = {
    "deepseek-7b-grok4": "Spock (Grok 4)",
    "qwen3-8b-flash": "Worf (Gemini Flash)",
